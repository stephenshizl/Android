...
public class TxtestActivity extends TestModule {
    ...
    OnClickListener sendOnClickListener = new OnClickListener() {
         ...
         public void onClick(View v) {
             Toast.makeText(TxtestActivity.this, R.string.sendok, 2000).show();
             OnClickToCommand();
         }
    };
    @Override
    ...
    public String getCommand() {
        ...
        String command = "btconfig /dev/smd3 rawcmd 0x3F 0x0004 0x06 ";
