...
public class AutoHomeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteResult();
        SystemProperties.set("persist.sys.cit", HomeActivity.CHINESE_LANGUAGE);
        ...
        menuListView.setOnItemClickListener(new OnItemClickListener() {
         ...
         //open gps..
        OpenGps();
        serverIntent.setClassName(AutoHomeActivity.this, "com.tools.cit.GpsServer");
    ...
    private void readResultfromPreference() {
        ...
        if(!resultString.equals("-1")) {
            ...
            for(int i = 0; i< automenuDatas.size(); i++) {
                automenuDatas.get(i).setState(Integer.valueOf(splitResult[i]));
            }
        }
    }
