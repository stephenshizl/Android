    ...
    private class BatteryBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context arg0, Intent intent) {
            if (intent.getAction().equals(Intent.ACTION_BATTERY_CHANGED)) {
                ...
                txtTemperature.setText("" + tenthsToFixedString(intent.getIntExtra(BatteryManager.EXTRA_TEMPERATURE, 0)));//  + getString(R.string.battery_info_temperature_units)
                txtVoltage.setText(" "+getBetteryParameters(CHARGING_VOLTAGE_PATH)+getString(R.string.battery_info_voltage_units));
                txtCurrent.setText(" "+getBetteryParameters(CHARGING_CURRENT_PATH)+getString(R.string.battery_info_current_units));
