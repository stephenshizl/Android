...
import com.tools.cit.BaseMenu.MenuData;
import com.tools.cit.R.string;
...
public class HomeActivity extends Activity {
    ...
    public static final String CHINESE_LANGUAGE="1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteResult();
        SystemProperties.set("persist.sys.cit", CHINESE_LANGUAGE);
        /*different version (english or chinese)
        project don't support chinese,can't combile chinese ,so set the project language to French 
        and take chinese strings into values-fr file to ensure compile correctly */
        ...
        serverIntent.setClassName(HomeActivity.this, "com.tools.cit.GpsServer");
