...
public class ProximityTest extends TestModule implements SensorEventListener {
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        FTLog.i(this, "enter sensor change onSensorChanged count= " + count);
        count ++;
        FTLog.i(this, "enter sensor change onSensorChanged count++= " + count);
        if (count >= 5){
            FTLog.i(this, "count >=5 pass " + count);
            setTestResult(PASS);
            findViewById(R.id.btn_pass).setEnabled(true);
            FTLog.i(this, " count >=5 pass " + count);
        }       
        FTLog.i(this, "accuracy: " + event.accuracy + ", value: " + event.values[0] + "count " + count);
    }
