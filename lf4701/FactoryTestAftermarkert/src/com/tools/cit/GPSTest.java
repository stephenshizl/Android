...
public class GPSTest extends TestModule {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serverIntent.setClassName(GPSTest.this, "com.tools.customercit.GpsServer");
        fillContent();
        startTimer();
        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                case 1:
                   ...
                   int sec = (totalSec % 60);
                   try {
                        tvTime.setText("Time : " + String.format("%1$02d:%2$02d:%3$d", min, sec, yushu) +  getString(R.string.gps_searchtime));
                   } catch (Exception e) {
                        tvTime.setText("" + min + ":" + sec + ":" + yushu);
                        e.printStackTrace();
                        FTLog.d(this, "Format string error.");
                   }
                   if(totalSec == 60) {
