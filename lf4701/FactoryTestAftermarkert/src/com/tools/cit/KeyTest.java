...
public class KeyTest extends TestModule {
    ...
    private final String AC1_COMMAND = "aftremarketkeyac_command";
    ...
    private int getACFlag(String path, boolean ac1) {
        ...
        /*if(ac1) {
           ...
           acPath = "/data/aftermarketcit_keyac1.txt"; 
        }*/
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        TextView v = null;
        TextView v1 = null;
        Log.i("keytest dispatchKeyEvent keyevent", "keytest dispatchKeyEvent keyevent" + event.getKeyCode());
        //Log.i("keytest dispatchKeyEvent","key dispatchKeyEvent " + getACFlag(AC1_PATH, true) + "ac2:" + getACFlag(AC2_PATH, false) + "scroll:" + getACFlag(SCROLL_PATH, true));
        ...
        switch (keyCode) {
            case KeyEvent.KEYCODE_VOLUME_DOWN:
               ...
               // Log.i("keytest dispatchKeyEvent","key dispatchKeyEvent before" + getACFlag(AC1_PATH, true) + "ac2:" + getACFlag(AC2_PATH, false) + "scroll:" + getACFlag(SCROLL_PATH, true));
                ...
                if(getACFlag(AC2_PATH, false)== 55 ){
                    ...
                    Log.i("keytest dispatchKeyEvent","key dispatchKeyEvent SCROLL_PATH volumdown");
                    KEYCODE_VOLUME_DOWN++; 
                    //setACFlag(SCROLL_PATH);
                }
                if(KEY_VOLUMEDOWN_AC2 == 1){
                 ...
                 //end by qianyan 
               //Log.i("keytest dispatchKeyEvent","key dispatchKeyEvent after1" + getACFlag(AC1_PATH, true) + "ac2:" + getACFlag(AC2_PATH, false) + "scroll:" + getACFlag(SCROLL_PATH, true));
            ...
            case KeyEvent.KEYCODE_VOLUME_UP:
                ...
                //Log.i("keytest dispatchKeyEvent","key dispatchKeyEvent volumup before" + getACFlag(AC1_PATH, true) + "ac2:" + getACFlag(AC2_PATH, false) + "scroll:" + getACFlag(SCROLL_PATH, true));
                if(getACFlag(AC2_PATH, false)== 55 ){
                    Log.i("keytest dispatchKeyEvent","key dispatchKeyEvent ac2 volumup" + getACFlag(AC2_PATH, false));
                    KEY_VOLUMEUP_AC2++;
                    //setACFlag(AC2_PATH);
                } else if(getACFlag(AC1_PATH, true)== 55){
                    ...
                    Log.i("keytest dispatchKeyEvent","key dispatchKeyEvent scroll_path volumup");
                    KEYCODE_VOLUME_UP++; 
                    //setACFlag(SCROLL_PATH);
                }
                ...
                //Log.i("keytest dispatchKeyEvent","key dispatchKeyEvent after" + getACFlag(AC1_PATH, true) + "ac2:" + getACFlag(AC2_PATH, false) + "scroll:" + getACFlag(SCROLL_PATH, true));
