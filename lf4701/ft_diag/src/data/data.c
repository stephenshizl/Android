...
//                        pDirent->d_ino, pDirent->d_off , pDirent->d_reclen, pDirent->d_type, pDirent->d_name);
        ...
        && (strcmp(pDirent->d_name,"..") != 0)) && (strcmp(pDirent->d_name, FLASH_SAVE_DIR_MOVIES) != 0)
        && (strcmp(pDirent->d_name, FLASH_SAVE_DIR_MUSIC) != 0) && (strcmp(pDirent->d_name, FLASH_SAVE_DIR_PICTURES) != 0)) {
