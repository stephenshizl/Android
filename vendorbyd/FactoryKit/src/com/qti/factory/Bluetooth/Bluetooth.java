...
public class Bluetooth extends Activity {
        ...
        Button falButton = null;
        Button sucButton = null;
	...
	void bindView() {
        ...
        sucButton = (Button) findViewById(R.id.bluetooth_suc);
        sucButton.setEnabled(false);
        sucButton.setOnClickListener(new OnClickListener() {
        ...
        falButton = (Button) findViewById(R.id.bluetooth_fal);
