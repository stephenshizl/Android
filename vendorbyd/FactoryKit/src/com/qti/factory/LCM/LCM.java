...
public class LCM extends Activity {
    ...
    private int[] mTestImg = {R.drawable.lcm_red, R.drawable.lcm_green, R.drawable.lcm_blue,
                R.drawable.lcm_white, R.drawable.lcm_gray, R.drawable.lcm_black,
                R.drawable.color4_fhd,R.drawable.crosstalknbfhd186,
                R.drawable.crosstalknwhd128,R.drawable.fhd1080_girl};/*R.drawable.lcm_black_white_lump, R.drawable.lcm_color_lump*/
