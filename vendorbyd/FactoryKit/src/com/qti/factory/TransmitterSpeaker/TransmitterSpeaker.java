 ...
 */
package com.qti.factory.TransmitterSpeaker;
...
public class TransmitterSpeaker extends Activity {
    String mAudiofilePath;
    static String TAG = "TransmitterSpeaker";
    ...
    void replay() throws IllegalArgumentException, IllegalStateException, IOException {
        ...
        mTextView.setText(getString(R.string.transmitter_speaker_playing));
        ...
        mMediaPlayer.setOnCompletionListener(new OnCompletionListener() {
            public void onCompletion(MediaPlayer mPlayer) {
                ...
                file.delete();
                final TextView mTextView = (TextView) findViewById(R.id.transmitter_receiver_hint);
                mTextView.setText(getString(R.string.transmitter_speaker_replay_end));
                showConfirmDialog();
            }
        });
    }
    ...
    void showConfirmDialog() {
        new AlertDialog.Builder(mContext).setTitle(getString(R.string.transmitter_speaker_confirm))
    ...
    void bindView() {
        ...
        final TextView mTextView = (TextView) findViewById(R.id.transmitter_receiver_hint);
        mTextView.setText(getString(R.string.transmitter_speaker_to_record));
        recordButton.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                if (!mAudioManager.isWiredHeadsetOn()) {
                    mTextView.setText(getString(R.string.transmitter_speaker_recording));
                    try {
        ...
        stopButton.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                if (isRecording) {
                    ...
                    showWarningDialog(getString(R.string.transmitter_speaker_record_first));
            }
        });
    }
    ...
    public boolean onKeyDown(int keyCode,KeyEvent event){
        ...
        if((KeyEvent.KEYCODE_BACK == keyCode) && startTest){
            return true;
        }
