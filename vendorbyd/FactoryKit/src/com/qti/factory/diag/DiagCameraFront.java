...
public class DiagCameraFront extends Activity implements SurfaceHolder.Callback {
    ...
    final static String TAG = "DiagCameraFront";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSurfaceHolder.addCallback(DiagCameraFront.this);
    ...
    private void startCamera() {
        ...
        if (mCamera != null) {
            try {
                ...
                //Begin shen.zhiyong@byd.com  20150430 add for set size dynamic
