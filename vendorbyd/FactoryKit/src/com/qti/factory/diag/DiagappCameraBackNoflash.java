...
public class DiagappCameraBackNoflash extends Activity implements SurfaceHolder.Callback {

    private Camera mCamera = null;
    private Button takeButton, passButton, failButton;
    private SurfaceView mSurfaceView;
    private SurfaceHolder mSurfaceHolder;
    final static String TAG = "DiagappCameraBackNoflash";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSurfaceHolder.addCallback(DiagappCameraBackNoflash.this);
