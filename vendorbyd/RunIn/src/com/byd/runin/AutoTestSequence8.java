...
public class AutoTestSequence8
{
    public static int cpu_time = 80 * 60 * 1000;
    public static int emmc_time = 40 * 60 * 1000;
    public static int memory_time = 40 * 60 * 1000;
    public static int video_time = 40 * 60 * 1000;
    public static int lcd_time = 40 * 60 * 1000;
    public static int _2d_time = 80 * 60 * 1000;
    public static int _3d_time = 80 * 60 * 1000;
    ...
    public static ArrayList < TestEntry > getTestSequence()
    {
        ...
        entry.time = 16; //s3 use counts test,use time to test have some problem
        result.add(entry);
