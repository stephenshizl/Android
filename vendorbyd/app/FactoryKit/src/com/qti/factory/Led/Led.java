...
public class Led extends Activity {
	...
	String RED_LED_DEV = "/sys/class/leds/chg_red/brightness";
	String GREEN_LED_DEV = "/sys/class/leds/chg_green/brightness";
	String BLUE_LED_DEV = "/sys/class/leds/chg_blue/brightness";
