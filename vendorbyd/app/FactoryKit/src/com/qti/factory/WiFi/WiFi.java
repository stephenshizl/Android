...
*/
	...
	void bindView() {
        ...
        btnSuc = (Button) findViewById(R.id.wifi_success);
        btnFail = (Button) findViewById(R.id.wifi_fail);
        btnSuc.setOnClickListener(btnSucListener);
        btnFail.setOnClickListener(btnFailListener);
        btnSuc.setEnabled(false);
    }

    private OnClickListener btnSucListener = new OnClickListener() {
		...
		public void handleMessage(Message msg) {
            ...
            if (wifiScanResult != null && wifiScanResult.size() > 0) {
                for (int i = 0; i < wifiScanResult.size(); i++) {
                    ...
                    s += " " + (i+1) + ": " + wifiScanResult.get(i).SSID + "(" + wifiScanResult.get(i).level + ")" + "\n\n";
