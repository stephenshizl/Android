...
public class AutoTestSequence16
{
    public static int cpu_time = 160 * 60 * 1000;
    public static int emmc_time = 90 * 60 * 1000;
    public static int memory_time = 90 * 60 * 1000;
    public static int video_time = 90 * 60 * 1000;
    public static int lcd_time = 90 * 60 * 1000;
    public static int _2d_time = 160 * 60 * 1000;
    public static int _3d_time = 160 * 60 * 1000;
