...
public class AutoTestSequence2
{
    public static int cpu_time = 20 * 60 * 1000; //20minutes
    public static int emmc_time = 10 * 60 * 1000; //10minutes
    public static int memory_time = 10 * 60 * 1000;
    public static int video_time = 10 * 60 * 1000;
    public static int lcd_time = 10 * 60 * 1000;
    public static int _2d_time = 20 * 60 * 1000;
    public static int _3d_time = 20 * 60 * 1000;
